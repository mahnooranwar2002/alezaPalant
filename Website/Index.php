...
?>
    ...
    <section class="new-arrivals-products-area bg-gray section-padding-100">
        <div class="container">
            ...
            <?php
$query="SELECT * FROM tbl_product where status = 1 And quantity !=0  Limit 4 ";
    ...
    echo "
                    ...
                    <div class='single-product-area mb-50 wow fadeInUp' data-wow-delay='100ms'>
                        ...
                        <div class='product-img'>
                            <a href='shop.php'><img src='../Adminpanel/assets/productImage/$data[product_image]' ></a>
                            ...
                            <div class='product-meta d-flex'>
                                ...
                                <a href='#' class='compare-btn'><i class='
                                arrow_left-right_alt'></i></a>
                            </div>
                        </div>
                        <!-- Product Info -->
                    ...
                    <div class="contact-form-area mb-100">
                        <form action="#" method="post">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <input type="email" class="form-control" id="contact-email" placeholder="Your Email"  name="email">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="contact-subject" placeholder="Subject"  name="sub">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <button type="submit" name="conBtn" class="btn alazea-btn mt-15">Send Message</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
if(isset($_POST['conBtn'])){
    ...
    $sub=$_POST['sub'];
    $msg=$_POST['message'];
    $query=mysqli_query($con,"INSERT INTO `tbl_contact`(`name`, `email`, `subject`, `msg`) VALUES ('$name','$email','$sub','$msg')");
    if($query){
