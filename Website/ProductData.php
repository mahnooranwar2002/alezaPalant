                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                      ...
                                      <?php
                                      echo" <img class='d-block w-100' src='../Adminpanel/assets/productImage/" . htmlspecialchars($data['product_image']) . "' alt='1'>";
...
<form method="post">
    ...
    <input type='hidden' name='p_name' value="<?php echo $data["product_name"]?>">
    <input type='hidden' name='product_image' value="<?php echo $data['product_image']?>">
<button type="submit" name="wishtlistBtn" class="wishlist-btn ml-15 " style="border: none;"><i class="icon_heart_alt"></i></button> 
</form>
...
// for add to cart
    ...
    if( $data['quantity']>= $qty)
        {
            $query="INSERT INTO `tbl_cart`( `p_id`, `user_id`, `p_name`, `p_image`, `qunatity`, `price`, `total`) VALUES ('$pId','$userId','$pName','$pImage',$qty,$price,$total)";
            $updateQuery="UPDATE `tbl_product` SET `quantity`= $data[quantity]-$qty WHERE `id`=$pId";
            $result=mysqli_query($con,$query);
      ...
      echo "<script>alert('we do not have this much $qty');</script>";   
    }
    }
